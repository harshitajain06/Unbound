...
const CustomLayout = ({ children }) => {
  return (
    <div className="flex min-h-screen items-center justify-between-8 md:p-24 bg-neutral-900 relative">
      {children}
      ...
      {/* Keep only the anchor tag for linking to the home page */}
      <a href={"/"} className="text-green-200 fixed top-3 left-6 z-50 p-4 text-2xl font-MONO">
        Home
      </a>
    </div>
  );
